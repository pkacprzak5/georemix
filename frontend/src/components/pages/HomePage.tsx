...
export function HomePage() {
  ...
  const handleNavigateWithLoading = () => {
    ...
    navigateWithLoading(GroupName.MAIN_MENU, 'settings', fakePromise);
  };
  ...
  return (
    <div className="p-6">
      ...
      <div className="flex flex-col gap-2">
        <Button onClick={() => navigateTo(GroupName.MAIN_MENU, 'settings')}>
          Go to Settings
        </Button>
        <Button onClick={() => navigateTo(GroupName.MAIN_MENU, 'game')}>
          Go to Game
        </Button>
        <Button onClick={handleNavigateWithLoading}>
          Go to Settings with Loading
        </Button>
